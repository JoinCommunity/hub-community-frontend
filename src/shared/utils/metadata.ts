...
const META_URL = "https://github.com/JoinCommunity/hub-community-frontend.git";
const META_LOCAL_URL = "http://localhost:3000/";

export const META_IMAGE_PATH = isLocalMetadata ? "./" : META_URL;

export const META_NAME = "Hub Community";
const META_DESCRIPTION = `Hub Community is a JoinCommunity's frontend application. It is built with Next.js, TypeScript, ShadcnUI and Tailwind CSS.`;
